...
function IconAll({ className, color = 'black' } = {}) {
  return (
    <svg
      width="20"
      height="20"
    ...
    >
      ...
      />
      <path
        d="M8.75008 7.09996V3.31663C8.75008 2.14163 8.21675 1.66663 6.89175 1.66663H3.52508C2.20008 1.66663 1.66675 2.14163 1.66675 3.31663V7.09163C1.66675 8.27496 2.20008 8.74163 3.52508 8.74163H6.89175C8.21675 8.74996 8.75008 8.27496 8.75008 7.09996Z"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M12.5 16.25H17.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  )
}

export default React.memo(IconAll)
